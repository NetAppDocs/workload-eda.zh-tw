...
NOTE: 如果您的帳戶系統管理員已關閉 AI 功能，您將看到一則訊息，並且將無法使用 AI 分析。請聯絡您的系統管理員或 https://docs.netapp.com/us-en/workload-setup-admin/manage-genai-features.html["了解 AI 管理"^]。
...
* *NetApp 代管 AI 積分已啟用*：無需額外的 Bedrock 設定即可執行 AI 分析。
* *系統管理員已停用*：AI 選項無法使用。


如果已啟用 NetApp 代管 AI 積分，但您的每月預算已用完，則 AI 分析將無法使用，並會顯示一則訊息。
